...
class OverlappingIntervals:
    ...
    def __init__(
        ...
        self.data = (
            joined_result.joined.inspect("HI {}").groupby(group_keys)
            .agg([pl.all().explode(), *self.find_starts_in_ends()]).inspect("HO {}")
            .groupby(group_keys)
    ...
    def overlapping_pairs(
        ...
        self.missing_overlaps_left(df_column_names_without_groupby_ks, group_keys, include_right=True)
    ...
    def calculate_bottom_right(self, df_2_column_names_after_join, group_keys):
        ...
        return self.calculate_self_part(
            df_2_column_names_after_join, MASK_1IN2_PROPERTY, STARTS_1IN2_PROPERTY, ENDS_1IN2_PROPERTY, group_keys
        )
    ...
    def calculate_top_left(self, df_column_names_without_groupby_ks, group_keys):
        ...
        return self.calculate_self_part(
            mask_columns, MASK_2IN1_PROPERTY, STARTS_2IN1_PROPERTY, ENDS_2IN1_PROPERTY, group_keys
        )
                        ...
                        pl.concat(
                            [
                                ...
                                pl.int_ranges(
                                    ...
                                    end=pl.col(STARTS_1IN2_PROPERTY)
                                    .explode()
                                    .add(
    ...
    def _calculate_missing_other(
        self, df_column_names_without_groupby_ks, group_keys, starts_property, lengths_property
    ):
    ...
    def calculate_missing_bottom_right(self, df_2_column_names_after_join, group_keys):
        """Calculate the bottom right part of the final result.

        TODO: give better name. See new bioframe_lite.
        """
        return self._calculate_missing_other(
            df_column_names_without_groupby_ks=df_2_column_names_after_join,
            group_keys=group_keys,
    ...
    def missing_overlaps_right(self) -> pl.LazyFrame:
        """Return the missing overlaps on the left side of the join."""
